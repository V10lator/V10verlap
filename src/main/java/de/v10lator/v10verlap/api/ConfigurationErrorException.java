...
public class ConfigurationErrorException extends V10verlapException {
	private static final long serialVersionUID = -4182908251752101015L;
	...
	ConfigurationErrorException(Exception e)
	{
		super(e);
	}
}
