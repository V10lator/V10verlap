...
public class NotConfiguredException extends ConfigurationErrorException {
	private static final long serialVersionUID = -489852045494803999L;
	...
	NotConfiguredException(Exception e)
	{
		super(e);
	}
}
